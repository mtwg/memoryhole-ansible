...
require_once('modules/legal_events/legal_events.php');

class legal_eventsDashlet extends DashletGeneric { 
    function legal_eventsDashlet($id, $def = null) {
        ...
        if(empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'legal_events');
