...
*}
{if ! $MODULE_TAB|strstr:'legal_'}
	{assign var='SEARCH_MOD' value='legal_arrestees'}
{else}
	{assign var='SEARCH_MOD' value=$MODULE_TAB}
{/if} 
        <div id="search">
            <div class="wrapper">
                ...
                <form name='UnifiedSearch' action='index.php' onsubmit='return false;'>
                    ...
                    <input type="text" name="query_string" id="query_string" placeholder='Search {$SEARCH_MOD|replace:'legal_':''|capitalize}' value=""/>
