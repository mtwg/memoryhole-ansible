...
if(isset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']) && in_array('iFrames', $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules'])) {
   if(count($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules']) == 1) {
   	  unset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']);
   } else {
   	  $key = array_search('iFrames', $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules']);
   	  unset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules'][$key]);
   }
