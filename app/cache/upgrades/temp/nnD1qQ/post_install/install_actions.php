...
if(!isset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS'])) {
  $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS'] = array(
		'label' => 'LBL_TABGROUP_TOOLS',
        'modules' => array('iFrames')
        );
} else if(isset($GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']) && !in_array('iFrames', $GLOBALS['tabStructure']['LBL_TABGROUP_TOOLS']['modules'])) {
