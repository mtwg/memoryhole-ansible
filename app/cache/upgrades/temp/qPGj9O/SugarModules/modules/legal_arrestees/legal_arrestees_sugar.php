 ...
 * PLACE ANY CUSTOMIZATIONS IN legal_arrestees
 */

require_once('include/SugarObjects/templates/person/Person.php');

class legal_arrestees_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'legal_arrestees';
	var $object_name = 'legal_arrestees';
	var $table_name = 'legal_arrestees';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $release_time;
		var $date_of_birth;
		var $immigration_issues;
		var $felony_charges;
		var $minor;
		var $incident_id;
		var $citation_number;
		function legal_arrestees_sugar(){	
		parent::Person();
	}
