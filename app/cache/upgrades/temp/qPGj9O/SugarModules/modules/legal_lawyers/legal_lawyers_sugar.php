 ...
 * PLACE ANY CUSTOMIZATIONS IN legal_lawyers
 */

require_once('include/SugarObjects/templates/person/Person.php');

class legal_lawyers_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'legal_lawyers';
	var $object_name = 'legal_lawyers';
	var $table_name = 'legal_lawyers';
	var $importable = true;
