...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.reports_to_name.name}" id="btn_clr_{$fields.reports_to_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_TITLE"}"  class="button"
onclick="SUGAR.clearRelateField(this.form, '{$fields.reports_to_name.name}', '{$fields.reports_to_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_USERS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button><button type="button" name="btn_jump_{$fields.reports_to_name.name}" tabindex="0" title=""  class="button lastChild"
onclick="document.location='index.php?module={$fields.reports_to_name.module}&action=EditView&record={$fields.reports_to_id.value}';">View</button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
