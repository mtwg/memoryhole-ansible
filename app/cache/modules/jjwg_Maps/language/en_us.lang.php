...
$mod_strings = array (
  ...
  'LBL_CRON_INSTRUCTIONS' => 'To process the geocoding requests it is recommended to setup a nightly Cron-Job. A custom entry point has been created for this purpose and can be accessed without authentication. The URL shown below is meant to be used with an Administrative Scheduled Task. Please see the SugarCRM documentation for more information.',
  ...
  'LBL_ADD_TO_TARGET_LIST_CONFIRM' => 'Are you sure you want to add the Selected Items to the Target List?',
  ...
  'LBL_CONFIG_MAP_ADSENSE_REMOVAL_KEY_TITLE' => 'Map AdSense Removal Key:',
  'LBL_CONFIG_MAP_ADSENSE_REMOVAL_KEY_DESC' => 'Donate to this project! Then contact JJWDesign.com for an AdSense removal key.',
