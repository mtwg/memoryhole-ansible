...
addForm('EditView');addToValidate('EditView', 'name', 'varchar', true,'{/literal}{sugar_translate label='LBL_LIST_NAME' module='iFrames' for_js=true}{literal}' );
addToValidate('EditView', 'url', 'varchar', true,'{/literal}{sugar_translate label='LBL_LIST_URL' module='iFrames' for_js=true}{literal}' );
addToValidate('EditView', 'type', 'varchar', true,'{/literal}{sugar_translate label='LBL_LIST_TYPE' module='iFrames' for_js=true}{literal}' );
addToValidate('EditView', 'placement', 'varchar', true,'{/literal}{sugar_translate label='LBL_LIST_PLACEMENT' module='iFrames' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'bool', true,'{/literal}{sugar_translate label='LBL_LIST_STATUS' module='iFrames' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', true,'{/literal}{sugar_translate label='LBL_DELETED' module='iFrames' for_js=true}{literal}' );
...
addToValidate('EditView', 'created_by', 'assigned_user_name', true,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='iFrames' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='iFrames' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='iFrames' for_js=true}{literal}', 'assigned_user_id' );
</script>{/literal}
