...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='first_name_basic'> {sugar_translate label='LBL_FIRST_NAME' module='legal_witnesses'}
		</td>
...
<input type='text' name='{$fields.first_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='last_name_basic'> {sugar_translate label='LBL_LAST_NAME' module='legal_witnesses'}
		</td>
...
<input type='text' name='{$fields.last_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='legal_observer_basic' >{sugar_translate label='LBL_LEGAL_OBSERVER' module='legal_witnesses'}</label>
    	</td>
...
{if strval($fields.legal_observer_basic.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.legal_observer_basic.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.legal_observer_basic.name}" name="{$fields.legal_observer_basic.name}"   >
