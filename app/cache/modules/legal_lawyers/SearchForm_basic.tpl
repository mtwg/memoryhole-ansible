...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='first_name_basic'> {sugar_translate label='LBL_FIRST_NAME' module='legal_lawyers'}
		</td>
...
<input type='text' name='{$fields.first_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='last_name_basic'> {sugar_translate label='LBL_LAST_NAME' module='legal_lawyers'}
		</td>
...
<input type='text' name='{$fields.last_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='organization_c_basic' >{sugar_translate label='LBL_ORGANIZATION' module='legal_lawyers'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.organization_c_basic.value) <= 0}
{assign var="value" value=$fields.organization_c_basic.default_value }
{else}
{assign var="value" value=$fields.organization_c_basic.value }
{/if}  
<input type='text' name='{$fields.organization_c_basic.name}' 
    id='{$fields.organization_c_basic.name}' size='30' 
    maxlength='60' 
    value='{$value}' title=''      >
   	   	</td>
