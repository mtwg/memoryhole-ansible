<?php /* Smarty version 2.6.11, created on 2014-12-17 08:48:24
         compiled from modules/ModuleBuilder/tpls/layoutView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/layoutView.tpl', 46, false),array('function', 'sugar_help', 'modules/ModuleBuilder/tpls/layoutView.tpl', 54, false),array('function', 'sugar_image', 'modules/ModuleBuilder/tpls/layoutView.tpl', 67, false),array('function', 'counter', 'modules/ModuleBuilder/tpls/layoutView.tpl', 77, false),array('function', 'sugar_getimage', 'modules/ModuleBuilder/tpls/layoutView.tpl', 83, false),array('function', 'eval', 'modules/ModuleBuilder/tpls/layoutView.tpl', 101, false),array('modifier', 'upper', 'modules/ModuleBuilder/tpls/layoutView.tpl', 134, false),array('modifier', 'escape', 'modules/ModuleBuilder/tpls/layoutView.tpl', 302, false),)), $this); ?>
...
');"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('otherAttributes', ob_get_contents());ob_end_clean(); ?>
                <?php echo smarty_function_sugar_getimage(array('name' => 'edit_inline','ext' => ".gif",'other_attributes' => $this->_tpl_vars['otherAttributes']), $this);?>
            ...
            <?php endif; ?>
                ...
                <?php echo smarty_function_sugar_getimage(array('name' => "SugarLogic/icon_calculated",'alt' => $this->_tpl_vars['mod_strings']['LBL_CALCULATED'],'ext' => ".png",'other_attributes' => 'class="right_icon" '), $this);?>
            ...
            <?php if (isset ( $this->_tpl_vars['field_defs'][$this->_tpl_vars['field']]['dependency'] ) && $this->_tpl_vars['field_defs'][$this->_tpl_vars['field']]['dependency']): ?>
                <?php echo smarty_function_sugar_getimage(array('name' => "SugarLogic/icon_dependent",'ext' => ".png",'alt' => $this->_tpl_vars['mod_strings']['LBL_DEPENDANT'],'other_attributes' => 'class="right_icon" '), $this);?>
...
" <?php if ($this->_tpl_vars['tabDefs'][$this->_tpl_vars['panel_upper']]['panelDefault'] == 'collapsed'): ?>checked="checked"<?php endif; ?>
          onclick="<?php echo 'if(this.checked) { document.forms.prepareForSave.tabDefs_';  echo $this->_tpl_vars['panelid'];  echo '_panelDefault.value=\'collapsed\'; } else { document.forms.prepareForSave.tabDefs_';  echo $this->_tpl_vars['panelid'];  echo '_panelDefault.value=\'expanded\';}'; ?>
" />
        </span>
        <?php echo smarty_function_counter(array('name' => 'idCount','assign' => 'idCount','print' => false), $this);?>
...
<?php $_from = $this->_tpl_vars['layout']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['panelid'] => $this->_tpl_vars['panel']):
 ob_start();  echo ((is_array($_tmp=$this->_tpl_vars['panelid'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp));  $this->_smarty_vars['capture']['panel_upper'] = ob_get_contents();  $this->assign('panel_upper', ob_get_contents());ob_end_clean(); ?>
