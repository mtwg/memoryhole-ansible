<?php /* Smarty version 2.6.11, created on 2015-01-07 11:25:26
         compiled from cache/modules/legal_arrestees/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 44, false),array('function', 'sugar_getimage', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 411, false),array('function', 'html_options', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 456, false),array('modifier', 'default', 'cache/modules/legal_arrestees/SearchForm_advanced.tpl', 422, false),)), $this); ?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['arrest_date_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['arrest_date_advanced_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['arrest_date_advanced_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['arrest_date_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_arrest_date_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_arrest_date_advanced'] ) && ! empty ( $_REQUEST['arrest_date_advanced'] )):  echo $_REQUEST['arrest_date_advanced'];  else:  echo $_REQUEST['range_arrest_date_advanced'];  endif; ?>' title=''   size="11" style="width:100px !important;">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
...
" value='<?php echo $_REQUEST['start_range_arrest_date_advanced']; ?>
...
" value='<?php echo $_REQUEST['end_range_arrest_date_advanced']; ?>
...
<?php $this->assign('id', $this->_tpl_vars['fields']['first_appearance_date_c_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['first_appearance_date_c_advanced_range_choice'] )):  $this->assign('starting_choice', $_REQUEST['first_appearance_date_c_advanced_range_choice']);  else:  $this->assign('starting_choice', "=");  endif; ?>
...
_range_choice" style="width:125px !important;" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['first_appearance_date_c_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_first_appearance_date_c_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_first_appearance_date_c_advanced'] ) && ! empty ( $_REQUEST['first_appearance_date_c_advanced'] )):  echo $_REQUEST['first_appearance_date_c_advanced'];  else:  echo $_REQUEST['range_first_appearance_date_c_advanced'];  endif; ?>' title='If you change this, please paste old values into 'Court Notes' below'   size="11" style="width:100px !important;">
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
...
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_first_appearance_date_c_advanced']; ?>
' title='If you change this, please paste old values into 'Court Notes' below'  tabindex='' size="11" style="width:100px !important;">
<?php ob_start(); ?>align="absmiddle" border="0" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ($this->_tpl_vars['APP']).".LBL_ENTER_DATE other_attributes=".($this->_tpl_vars['other_attributes'])), $this);?>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_first_appearance_date_c_advanced']; ?>
' title='If you change this, please paste old values into 'Court Notes' below'  tabindex='' size="11" style="width:100px !important;" maxlength="10">
<?php ob_start(); ?>align="absmiddle" border="0" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'alt' => ($this->_tpl_vars['APP']).".LBL_ENTER_DATE other_attributes=".($this->_tpl_vars['other_attributes'])), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='affinity_group_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AFFINITY_GROUP','module' => 'legal_arrestees'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['affinity_group_c_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['affinity_group_c_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['affinity_group_c_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['affinity_group_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['affinity_group_c_advanced']['name']; ?>
' size='30' 
    maxlength='25' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='case_status_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CASE_STATUS','module' => 'legal_arrestees'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'case_status_c_advanced','name' => 'case_status_c_advanced[]','options' => $this->_tpl_vars['fields']['case_status_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['case_status_c_advanced']['value']), $this);?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_id_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_id_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_lawyer_advanced\']={"form":"search_form","method":"query","modules":["legal_lawyers"],"group":"or","field_list":["name","id"],"populate_list":["lawyer_advanced","account_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};</script>'; ?>