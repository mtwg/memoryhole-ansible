...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/ModuleBuilder/tpls/MBModule/field.tpl', 93, false),array('function', 'html_options', 'modules/ModuleBuilder/tpls/MBModule/field.tpl', 95, false),array('function', 'sugar_help', 'modules/ModuleBuilder/tpls/MBModule/field.tpl', 96, false),)), $this); ?>
...
' 
	    ...
	    <?php if (! empty ( $this->_tpl_vars['vardef']['name'] )): ?>
	        ...
	        <?php echo '
	            &nbsp;<input type=\'button\' class=\'button\' name=\'fdeletebtn\' value=\'';  echo $this->_tpl_vars['mod_strings']['LBL_BTN_DELETE'];  echo '\' onclick=\'if(confirm("';  echo $this->_tpl_vars['mod_strings']['LBL_CONFIRM_FIELD_DELETE'];  echo '")){document.popup_form.action.value="DeleteField";ModuleBuilder.submitForm("popup_form_id");}\'>
	        '; ?>

	        <?php endif; ?>
	        <?php if (! $this->_tpl_vars['no_duplicate']): ?>
	        <?php echo '
	        &nbsp;<input type=\'button\' class=\'button\' name=\'fclonebtn\' value=\'';  echo $this->_tpl_vars['mod_strings']['LBL_BTN_CLONE'];  echo '\' onclick=\'document.popup_form.action.value="CloneField";ModuleBuilder.submitForm("popup_form_id");\'>
	        '; ?>
	...
	<?php else: ?>
	    <?php echo '
	     <input type=\'button\' class=\'button\' name=\'lsavebtn\' value=\'';  echo $this->_tpl_vars['mod_strings']['LBL_BTN_SAVE'];  echo '\' onclick=\'if(check_form("popup_form")){this.form.action.value = "';  echo $this->_tpl_vars['action'];  echo '";ModuleBuilder.submitForm("popup_form_id")};\'>
	    '; ?>
	    ...
	    <?php echo '
		 ...
		 <?php echo '
	        &nbsp;<input type=\'button\' class=\'button\' name=\'cancel\' value=\'';  echo $this->_tpl_vars['mod_strings']['LBL_BTN_CANCEL'];  echo '\' onclick=\'ModuleBuilder.tabPanel.get("activeTab").close()\'>
	        '; ?>
...
function validate_type_selection(){
    ...
    if(typeSel && typeSel.options){
        if(typeSel.options[typeSel.selectedIndex].value == \'\'){
            alert(\'';  echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'ERR_SELECT_FIELD_TYPE'), $this); echo '\');
            return false;
        }
    }
