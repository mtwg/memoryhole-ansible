<?php /* Smarty version 2.6.11, created on 2014-12-29 15:07:40
         compiled from cache/modules/Import/legal_arresteesstate_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'cache/modules/Import/legal_arresteesstate_c.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/modules/Import/legal_arresteesstate_c.tpl', 43, false),array('modifier', 'lookup', 'cache/modules/Import/legal_arresteesstate_c.tpl', 38, false),array('modifier', 'count', 'cache/modules/Import/legal_arresteesstate_c.tpl', 143, false),)), $this); ?>
...
<?php else: ?>
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['state_c']['options']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['state_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
	<?php ob_start();  echo $this->_tpl_vars['fields']['state_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
