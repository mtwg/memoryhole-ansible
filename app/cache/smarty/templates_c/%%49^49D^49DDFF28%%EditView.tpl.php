<?php /* Smarty version 2.6.11, created on 2015-04-03 11:39:59
         compiled from cache/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Contacts/EditView.tpl', 59, false),array('function', 'counter', 'cache/modules/Contacts/EditView.tpl', 65, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/EditView.tpl', 68, false),array('function', 'sugar_translate', 'cache/modules/Contacts/EditView.tpl', 71, false),array('function', 'html_options', 'cache/modules/Contacts/EditView.tpl', 88, false),array('function', 'sugar_getjspath', 'cache/modules/Contacts/EditView.tpl', 269, false),array('modifier', 'default', 'cache/modules/Contacts/EditView.tpl', 64, false),array('modifier', 'strip_semicolon', 'cache/modules/Contacts/EditView.tpl', 82, false),array('modifier', 'lookup', 'cache/modules/Contacts/EditView.tpl', 596, false),array('modifier', 'count', 'cache/modules/Contacts/EditView.tpl', 676, false),)), $this); ?>
...
" class="button" onclick="var _form = document.getElementById('EditView'); _form.return_module.value='Contacts'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
"></button><button type="button" name="btn_jump_<?php echo $this->_tpl_vars['fields']['account_name']['name']; ?>
" tabindex="0" title=""  class="button lastChild"
onclick="document.location='index.php?module=<?php echo $this->_tpl_vars['fields']['account_name']['module']; ?>
&action=EditView&record=<?php echo $this->_tpl_vars['fields']['account_id']['value']; ?>
';">View</button>
</span>
...
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button><button type="button" name="btn_jump_<?php echo $this->_tpl_vars['fields']['report_to_name']['name']; ?>
" tabindex="0" title=""  class="button lastChild"
onclick="document.location='index.php?module=<?php echo $this->_tpl_vars['fields']['report_to_name']['module']; ?>
&action=EditView&record=<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
';">View</button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
...
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button><button type="button" name="btn_jump_<?php echo $this->_tpl_vars['fields']['campaign_name']['name']; ?>
" tabindex="0" title=""  class="button lastChild"
onclick="document.location='index.php?module=<?php echo $this->_tpl_vars['fields']['campaign_name']['module']; ?>
&action=EditView&record=<?php echo $this->_tpl_vars['fields']['campaign_id']['value']; ?>
';">View</button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
