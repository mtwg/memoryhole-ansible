<?php /* Smarty version 2.6.11, created on 2014-12-23 21:46:13
         compiled from modules/EmailMan/tpls/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/EmailMan/tpls/config.tpl', 46, false),)), $this); ?>
<!--
/*********************************************************************************
...
function change_state(radiobutton) {
	...
	if (radiobutton.value == \'1\') {
		...
		radiobutton.form[\'massemailer_tracking_entities_location\'].value=\'';  echo $this->_tpl_vars['MOD']['TRACKING_ENTRIES_LOCATION_DEFAULT_VALUE'];  echo '\';
	} else {
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
		<tr><th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_OUTBOUND_CONFIGURATION']; ?>
</h4></th>
		</tr>
		<tr>
			     ...
			     <div id="smtp_settings">
					<table width="100%" cellpadding="0" cellspacing="0">
						<tr id="mailsettings1">
							...
							<td width="30%" ><input type="text" id="mail_smtpserver" name="mail_smtpserver" tabindex="1" size="25" maxlength="64" value="<?php echo $this->_tpl_vars['mail_smtpserver']; ?>
"></td>
...
>
						...
						<tr id="smtp_auth1">
                            ...
                            <td width="30%" ><input type="text" id="mail_smtpuser" name="mail_smtpuser" size="25" maxlength="64" value="<?php echo $this->_tpl_vars['mail_smtpuser']; ?>
" tabindex='1' ></td>
                            <td width="20%">&nbsp;</td>
                            <td width="30%">&nbsp;</td>
                       </tr>
...
>
		...
		<tr><td colspan="4">&nbsp;</tr>
		<tr>
		    <td width="15%"><input type="button" class="button" value="<?php echo $this->_tpl_vars['APP']['LBL_EMAIL_TEST_OUTBOUND_SETTINGS']; ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
	<tr>
		<th align="left" scope="row" colspan="4">
			<h4><?php echo $this->_tpl_vars['MOD']['LBL_NOTIFY_TITLE']; ?>
</h4>
		</th>
    </tr>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
			<tr>
				<th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_SECURITY_TITLE']; ?>
</h4></th>
			</tr>
			<tr>
				<td align="left" scope="row" colspan="4">
...
>&nbsp; &lt;object&gt;
				...
				<td width="40%" NOWRAP valign="middle" >
					<input type="checkbox" value="1" name="style" id="style" <?php echo $this->_tpl_vars['styleChecked']; ?>
>&nbsp; &lt;style&gt;
				</td>
			</tr>
			<tr>
...
';  if (! empty ( $this->_tpl_vars['mail_smtptype'] )):  echo '
changeEmailScreenDisplay("';  echo $this->_tpl_vars['mail_smtptype'];  echo '", false);
';  endif;  echo '
-->
</script>
'; ?>
