<?php /* Smarty version 2.6.11, created on 2014-12-24 10:54:40
         compiled from modules/Calendar/tpls/repeat.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/Calendar/tpls/repeat.tpl', 55, false),array('modifier', 'default', 'modules/Calendar/tpls/repeat.tpl', 87, false),)), $this); ?>
...
<?php echo '
	...
	function toggle_repeat_end(){	
		if(document.getElementById("repeat_count_radio").checked){
			...
			addToValidateMoreThan(\'CalendarRepeatForm\', \'repeat_count\', \'int\', true,\'';  echo $this->_tpl_vars['MOD']['LBL_REPEAT_COUNT'];  echo '\', 1);			
		}else{
			...
			addToValidate(\'CalendarRepeatForm\', \'repeat_until\', \'date\', true,\'';  echo $this->_tpl_vars['MOD']['LBL_REPEAT_UNTIL'];  echo '\');			
		}
