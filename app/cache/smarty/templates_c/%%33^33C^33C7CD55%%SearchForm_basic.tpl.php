<?php /* Smarty version 2.6.11, created on 2015-01-05 15:20:57
         compiled from cache/modules/legal_witnesses/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/legal_witnesses/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/legal_witnesses/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/legal_witnesses/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimagepath', 'cache/modules/legal_witnesses/SearchForm_basic.tpl', 138, false),array('modifier', 'count', 'cache/modules/legal_witnesses/SearchForm_basic.tpl', 125, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='first_name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'legal_witnesses'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='last_name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'legal_witnesses'), $this);?>
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='legal_observer_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEGAL_OBSERVER','module' => 'legal_witnesses'), $this);?>
</label>
    	</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['legal_observer_basic']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['legal_observer_basic']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['legal_observer_basic']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['legal_observer_basic']['name']; ?>
"   >
