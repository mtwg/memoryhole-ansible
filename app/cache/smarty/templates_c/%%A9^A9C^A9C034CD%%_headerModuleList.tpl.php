<?php /* Smarty version 2.6.11, created on 2015-01-17 16:41:25
         compiled from themes/Suite7/tpls/_headerModuleList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_link', 'themes/Suite7/tpls/_headerModuleList.tpl', 46, false),array('modifier', 'is_array', 'themes/Suite7/tpls/_headerModuleList.tpl', 195, false),)), $this); ?>
<?php if ($this->_tpl_vars['USE_GROUP_TABS'] && 0): ?>
    <div id="moduleList">
        <ul>
...
"><span><?php echo $this->_tpl_vars['item']['LABEL']; ?>
                            ...
                            <?php endforeach; endif; unset($_from); ?>
                                    ...
                                    <?php if ($this->_tpl_vars['name'] == 'Home' && ! $this->_tpl_vars['lock_homepage']): ?>
                                        ...
                                        <li style="margin-top:5px; margin-bottom:5px;"><a href="" onclick="addDashboardForm();return false"><?php echo $this->_tpl_vars['APP']['LBL_ADD_TAB']; ?>
</a></li>
...
"
                                                       href="<?php echo smarty_function_sugar_link(array('module' => $this->_tpl_vars['item']['module_name'],'action' => 'EditView','record' => $this->_tpl_vars['item']['item_id'],'link_only' => 1), $this);?>
">
...
if ($this->_foreach['moduleList']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['name'] => $this->_tpl_vars['module']):
        $this->_foreach['moduleList']['iteration']++;
?>
	<?php if ($this->_tpl_vars['name'] != 'iFramess'): ?>
            <?php if ($this->_tpl_vars['name'] == $this->_tpl_vars['MODULE_TAB']): ?>
            <li onclick="window.location = '<?php echo smarty_function_sugar_link(array('id' => "moduleTab_".($this->_tpl_vars['name']),'module' => $this->_tpl_vars['name'],'data' => $this->_tpl_vars['module'],'link_only' => 1), $this);?>
'">
                <span class="currentTabLeft">&nbsp;</span>
                <span class="currentTab"><?php echo smarty_function_sugar_link(array('id' => "moduleTab_".($this->_tpl_vars['name']),'module' => $this->_tpl_vars['name'],'data' => $this->_tpl_vars['module']), $this);?>
</span><span>&nbsp;</span>
...
'">
            ...
            <?php if (! ((is_array($_tmp=$this->_tpl_vars['module'])) ? $this->_run_mod_handler('is_array', true, $_tmp) : is_array($_tmp))): ?>
            <ul class="cssmenu">
                <?php if (count ( $this->_tpl_vars['shortcutTopMenu'][$this->_tpl_vars['name']] ) > 0): ?>
                <h3 class="home_h2"><?php echo $this->_tpl_vars['APP']['LBL_LINK_ACTIONS']; ?>
</h3>
...
?>
	...
	<li>
            <a href='#'>Tools</a><br />
            <ul class="cssmenu">
                <li><a href='reports/dockets.php' target='_blank'>Docket Sheet Generator</a></li>
                <li><a href='reports/courtdates.php' target='_blank'>AC Court Date Checker</a></li>
                <li><a href='reports/find_dupes.php' target='_blank'>Find Duplicate Arrestees</a></li>
                <li><a href='http://www.acgov.org/sheriff_app/' target='_blank'>AC Inmate Locator</a></li>
                <li><a href='reports/docketFinder.php' target='_blank'>AC Docket Finder</a></li>
                <li><a href='reports/import_webform_csv.php' target='_blank'>Import Entries from Online Intake</a></li>
            </ul>
        </li>
    </div>
<?php endif; ?>