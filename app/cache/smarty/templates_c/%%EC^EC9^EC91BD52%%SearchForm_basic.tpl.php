<?php /* Smarty version 2.6.11, created on 2015-01-05 14:36:31
         compiled from cache/modules/legal_lawyers/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/legal_lawyers/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/legal_lawyers/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/legal_lawyers/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimagepath', 'cache/modules/legal_lawyers/SearchForm_basic.tpl', 129, false),array('modifier', 'count', 'cache/modules/legal_lawyers/SearchForm_basic.tpl', 116, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='first_name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'legal_lawyers'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='last_name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'legal_lawyers'), $this);?>
...
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='organization_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ORGANIZATION','module' => 'legal_lawyers'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['organization_c_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['organization_c_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['organization_c_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['organization_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['organization_c_basic']['name']; ?>
' size='30' 
    maxlength='60' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
