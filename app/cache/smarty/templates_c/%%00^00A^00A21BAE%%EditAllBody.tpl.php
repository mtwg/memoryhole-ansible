...
<?php $_from = $this->_tpl_vars['CATEGORIES']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
 ...
 if ($this->_tpl_vars['CATEGORY_NAME'] == 'Accounts'): ?>
...
')"><b><?php echo $this->_tpl_vars['ACTION_LABEL']; ?>
				...
				<div  style="display: none; text-align: center;" id="<?php echo $this->_tpl_vars['ACTION_NAME']; ?>
">
...
');" >
		...
		<?php endforeach; endif; unset($_from);  endforeach; else: ?>

          <td colspan="2">&nbsp;</td>

<?php endif; unset($_from);  endif;  endforeach; endif; unset($_from); ?>
</TR>
<?php echo '
