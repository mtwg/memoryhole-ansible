 ...
 * PLACE ANY CUSTOMIZATIONS IN legal_witnesses
 */

require_once('include/SugarObjects/templates/person/Person.php');

class legal_witnesses_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'legal_witnesses';
	var $object_name = 'legal_witnesses';
	var $table_name = 'legal_witnesses';
		var $id;
		var $name;
		var $date_entered;
		var $date_modified;
	...
	function legal_witnesses_sugar(){	
		parent::Person();
	}
