DROP TABLE IF EXISTS `legal_arresal_witnesses`;
...
--
-- Table structure for table `legal_arresegal_charges`
--

DROP TABLE IF EXISTS `legal_arresegal_charges`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_arresgal_evidence`
--

DROP TABLE IF EXISTS `legal_arresgal_evidence`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_arreslegal_events`
--

DROP TABLE IF EXISTS `legal_arreslegal_events`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_arrestees`
--

DROP TABLE IF EXISTS `legal_arrestees`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_arrestees_audit`
--

DROP TABLE IF EXISTS `legal_arrestees_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_arrestees_cstm`
--

DROP TABLE IF EXISTS `legal_arrestees_cstm`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `legal_arrestees_cstm` (
  ...
  `next_hearing_time_c` varchar(60) default NULL,
...
--
-- Table structure for table `legal_charges`
--

DROP TABLE IF EXISTS `legal_charges`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_charges_audit`
--

DROP TABLE IF EXISTS `legal_charges_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_evental_witnesses`
--

DROP TABLE IF EXISTS `legal_evental_witnesses`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_eventgal_evidence`
--

DROP TABLE IF EXISTS `legal_eventgal_evidence`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_events_audit`
--

DROP TABLE IF EXISTS `legal_events_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_evidence`
--

DROP TABLE IF EXISTS `legal_evidence`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_evidence_audit`
--

DROP TABLE IF EXISTS `legal_evidence_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_evidence_cstm`
--

DROP TABLE IF EXISTS `legal_evidence_cstm`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_lawyers`
--

DROP TABLE IF EXISTS `legal_lawyers`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_lawyers_audit`
--

DROP TABLE IF EXISTS `legal_lawyers_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_lawyers_cstm`
--

DROP TABLE IF EXISTS `legal_lawyers_cstm`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_witnesses`
--

DROP TABLE IF EXISTS `legal_witnesses`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_witnesses_audit`
--

DROP TABLE IF EXISTS `legal_witnesses_audit`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Table structure for table `legal_witnesses_cstm`
--

DROP TABLE IF EXISTS `legal_witnesses_cstm`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
